...
<div id="contentForm">
        ...
        <table class="table table-striped table-bordered">
          <thead>
            <tr>
              <th width="30%">글쓴이</th>
              <td width="70%">${reply.id}</td>
            </tr>
            <tr>
              <th style="padding-top: 15px">제목</th>
              <td><input type="text" name="title" value="${reply.title}"
          ...
          <tbody>
            <tr>
              <td colspan="2">
                <textarea class="form-control" rows="20" name="content" >${reply.content}</textarea>
              </td>
            </tr>
...
<button onclick="reply(myForm)">삭제</button><br>
</div>
</div>
